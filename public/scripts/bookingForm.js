...
$(document).ready(function () {
    ...
    formSubmitBtn.addEventListener('click', function (event) {
        ...
        if (currentStep === 1) {
            ...
            if (!emailRegex.test(email)) {
                showAlert('Please enter the correct format for email address to ensure you get the notification!');
                return false;
            }
            ...
            if (duration < 1) {
                showAlert('Duration cannot be zero or negative!');
                return false;
            }
            if (date < today) {
                showAlert('Date should not be empty or in the past!');
                return false;
            }
            ...
            if (numOfStudents < 1) {
                showAlert('Number of students cannot be zero or negative!');
                return false;
            }
    ...
    function sendBookingData() {
        ...
        fetch('/public/user/makebooking.php', {
            method: 'POST',
            headers: {
            ...
            .then(data => {
                if (data.message === 'Booking successful!') {
                    showAlert('Booking successful! Redirecting...', () => {
                        window.location.href = '/public/user/viewbooking.php';
                    });
                } else {
